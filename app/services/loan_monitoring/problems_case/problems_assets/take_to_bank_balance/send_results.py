...
def upload_problems_assets_files(request, file_path, db_session):
    ...
    if problems_assets_data is None:
        ...
        problems_assets_data.problem_case.updated_at = datetime.datetime.now()
    ...
    if get_problems_state_notification is None:
        new_problems_state_notification = ProblemsStateNotification(loan_portfolio_id = get_problems_case.loan_portfolio_id, problems_assets_get_status_id = problems_assets_status['на проверку'])
        db_session.add(new_problems_state_notification)
        flush_object(db_session)
    else:
        get_problems_state_notification.problems_assets_get_status_id = problems_assets_status['на проверку']
...
def upload_problems_assets_decision(request, file_path, db_session):
    ...
    get_problems_state_notification.problems_assets_get_status_id = problems_assets_status['завершен']
