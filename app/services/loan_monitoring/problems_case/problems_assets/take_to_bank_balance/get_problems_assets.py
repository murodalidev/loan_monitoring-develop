...
def get_problems_assets_details(problem_case_id, problems_assets_type_id, db_session):
    ...
    if problems_assets is not None:
        problems_assets_datas ={"id":problems_assets.id,
                            ...
                            "third_responsible": problems_assets.third_responsible_id and {"id":problems_assets.third_responsible.id,
                                                                                         "full_name":problems_assets.third_responsible.full_name} or None,
