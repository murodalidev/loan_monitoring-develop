...
def accept_or_rework_problems_assets_data(request, db_session):
    ...
    if request.result_type:
        ...
        get_problems_case.updated_at = datetime.datetime.now()
        get_problems_case.checked_status=False
        problems_assets_data.third_responsible_id = get_lawyer.id
        problems_assets_data.turn = get_lawyer.id
        get_problems_state_notification.problems_assets_get_status_id = problems_assets_status['юристу']
        ...
        get_problems_state_notification.problems_assets_get_status_id = problems_assets_status['переделать']
