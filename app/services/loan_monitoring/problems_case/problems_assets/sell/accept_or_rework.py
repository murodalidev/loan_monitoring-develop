...
def accept_or_rework_problems_assets_sell_data(request, db_session):
    info_logger.info("user %s required 'accept_or_rework_problems_assets_data' method", request.from_user)
    ...
    if request.result_type:
        ...
        body = notification_body['accept_problems_assets']
        
        
        problems_assets_data.turn = request.from_user
        get_problems_state_notification.problems_assets_sell_status_id = problems_assets_status['проверено']
        ...
        data.to_user_id =request.from_user
        ...
        body = notification_body['rework_problems_assets']
        
        problems_assets_data.turn = request.to_user
        get_problems_state_notification.problems_assets_sell_status_id = problems_assets_status['переделать']
        
        file_path = files_crud.set_wrong_files(request.wrong_files, problems_assets_data, db_session)
        flush_object(db_session)
        info_logger.info("user %s sent problems_assets to rework", request.from_user)
    ...
    problems_assets_data.assets_status_id = status
