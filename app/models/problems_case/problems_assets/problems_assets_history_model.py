...
class ProblemsAssetsHistory(Base):
    __tablename__='problems_assets_history'
    ...
    from_user = relationship("Users", foreign_keys="ProblemsAssetsHistory.from_user_id")
    to_user_id = Column(Integer, ForeignKey('users.id'), nullable = True, index=True)
    to_user = relationship("Users", foreign_keys="ProblemsAssetsHistory.to_user_id")
