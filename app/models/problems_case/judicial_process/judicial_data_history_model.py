...
class JudicialDataHistory(Base):
    __tablename__='judicial_data_history'
    ...
    from_user = relationship("Users", foreign_keys="JudicialDataHistory.from_user_id")
    to_user_id = Column(Integer, ForeignKey('users.id'), nullable = True, index=True)
    to_user = relationship("Users", foreign_keys="JudicialDataHistory.to_user_id")
